...
const JoinUs: React.FC = () => {
  return (
    <section className="py-6 mx-auto items-center justify-center  bg-white text-white">
      <div className="container w-4/5 sm:w-3/5 mx-auto flex flex-col items-center bg-uptickblue100 rounded-lg justify-center p-4 space-y-6 md:p-10 md:px-10 xl:px-12">
